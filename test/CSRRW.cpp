...
DEFINE_TESTCASE(CSRRW) {
    ...
    ASSERT(csrs_updated[sel_csr] == val, "Wrong CSRSW result. Expected {:x} in CSR {:x}, got {:x}", val, sel_csr, csrs_updated[sel_csr]);
