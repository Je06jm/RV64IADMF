...
DEFINE_TESTCASE(BEQ, "BEQ") {
    ...
    ASSERT(vm.GetPC() == (base + jump), "BEQ {} == {} did not jump. Expected {:x}, got {:x}", rs1.u64, rs2.u64, (base + jump), vm.GetPC());
    ...
    ASSERT(vm.GetPC() == (base + 4), "BEQ {} != {} did jump. Expected {:x}, got {:x}", rs1.u64, rs2.u64, (base + 4), vm.GetPC());
